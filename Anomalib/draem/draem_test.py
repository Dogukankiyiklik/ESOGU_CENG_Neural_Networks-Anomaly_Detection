...
model = Draem.load_from_checkpoint("/content/anomaly_detection/checkpoints/Draem/wood/latest/weights/lightning/model.ckpt")
...
# ------------------ Test ve Tahmin ------------------
engine = Engine(default_root_dir="/content/anomaly_detection")
