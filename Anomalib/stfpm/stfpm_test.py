...
model = Stfpm.load_from_checkpoint("/content/checkpoints/Stfpm/wood/latest/weights/lightning/model.ckpt")
...
evaluate_iou_simple(
    results,
    gt_dir="/content/drive/MyDrive/preprocessed_wood_dataset/wood/ground_truth/defect",
    threshold=0.30
)
