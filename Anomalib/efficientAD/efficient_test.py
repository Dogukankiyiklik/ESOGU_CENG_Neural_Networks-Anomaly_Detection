...
model = EfficientAd.load_from_checkpoint("/content/checkpoints/EfficientAd/wood_folder/latest/weights/lightning/model.ckpt")
...
evaluate_iou_simple(
    results,
    gt_dir="/content/drive/MyDrive/preprocessed_wood_dataset/wood/ground_truth/defect", # GT verilerinin konumu
    threshold=0.30 # Eşik değeri
)